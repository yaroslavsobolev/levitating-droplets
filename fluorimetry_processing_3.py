...
def get_concentration_from_spectrum(spectrum_file, spectrum_id=1,
        ...
        ref_file='fluorescence_data/2021_may_18/NewREF_Acquisition 1 2021-05-18 02_00_16.session__from558nm.txt',
...
if __name__ == '__main__':
    ...
    get_transfer_volume(target_file=target_file,
                        spectrum_id=1,
                        net_volume_in_mL=2,  #The net volume in the drum (mL)
                        number_of_droplets=2400) #Number of material transfer events